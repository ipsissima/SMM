...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--n_kappa_coarse", type=int, default=13)
    ...
    parser.add_argument("--n_h_coarse", type=int, default=33)
    ...
    parser.add_argument("--Tmax_min", type=float, default=20.0)
    parser.add_argument("--Tmax_max", type=float, default=120.0)
    ...
    parser.add_argument("--outdir", type=str, default="bifurcation_results_refined")
